...
const About = () => {
  return (
    <div id='about' className='relative font-[font2] lg:pt-20 pl-5 lg:pl-20 pr-6 min-h-screen'>
      <div>
        <h1 className='text-6xl'>About Me</h1>
      </div>

      <div className='circle h-80 w-80 bg-orange-500 absolute rounded-full blur-3xl top-1/4 bottom-10 left-10 z-0'></div>

      <div className='mt-10 relative z-10 flex flex-col lg:flex-row gap-10'>
        ...
        <img src={aboutimg} alt="" className='w-full max-w-[30rem] lg:w-124 self-center lg:self-auto'/>
      </div>
    </div>
  )
}
